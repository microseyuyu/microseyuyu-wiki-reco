...
const H = window, Q = H.trustedTypes, gt = Q ? Q.emptyScript : "", X = H.reactiveElementPolyfillSupport, K = { toAttribute(i, t) {
  ...
  return e;
} }, at = (i, t) => t !== i && (t == t || i == i), Y = { attribute: true, type: String, converter: K, reflect: false, hasChanged: at };
...
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), it = /'/g, nt = /"/g, ut = /^(?:script|style|textarea|title)$/i, At = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), yt = At(1), b = Symbol.for("lit-noChange"), u = Symbol.for("lit-nothing"), rt = /* @__PURE__ */ new WeakMap(), y = E.createTreeWalker(E, 129, null, false), St = (i, t) => {
