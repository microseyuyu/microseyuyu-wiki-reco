<template><div><h1 id="第七课-隋唐制度的变化与创新-教学设计" tabindex="-1"><a class="header-anchor" href="#第七课-隋唐制度的变化与创新-教学设计" aria-hidden="true">#</a> 第七课 隋唐制度的变化与创新 教学设计</h1>
<table>
<thead>
<tr>
<th>教学目标</th>
